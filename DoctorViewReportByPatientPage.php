...
<table width="1000" border="" align="center">
  ...
  <tr>
    <td height="60"><p align="left"><i style="font-family: 'Comic Sans MS', cursive; color: #999;"> Let's view reports</i> <i style="font-family: 'Comic Sans MS', cursive; color: #999;">have been raised based on patient you enter</i>.</p></td>
  </tr>
  <form action="DoctorViewReportByPatientPage.php" method="POST"> 
  <tr>
