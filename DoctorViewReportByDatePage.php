<?php
	...
	if(isset($_POST['search']))
	{
		...
		$query = "SELECT * FROM patientlocation
			      ...
			      INNER JOIN location
			      ON patientlocation.locationid = location.locationid
				  WHERE patientlocation.dateupdate = '$date'
...
<table width="1000" border="" align="center">
  ...
  <tr>
    <td height="60"><p align="left"><i style="font-family: 'Comic Sans MS', cursive; color: #999;"> Let's view reports that have been raised based on date you enter.</i></p></td>
  </tr>
  <form action="DoctorViewReportByDatePage.php" method="POST"> 
  <tr>
