...
<body>
<table width="745" height="533" border="0" align="center">
  <tr align="center">
  ...
  <form action="StaffLoginPage.php" method="POST">
  <tr align="center">
  ...
  <tr>
   	<td height="63" colspan="2" align="center"><input type="submit" name="login" value="Login" /></td>
  </tr>
  </form>
</table>
</body>
...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	$query = "SELECT * FROM user WHERE username = '$username' AND password = '$password' AND role = 'Staff'";
